...
const SavedPlans: React.FC<SavedPlansProps> = ({ plans, archivedPlans, history, onSelectPlan, onArchivePlan, onRestorePlan, onDeletePermanently, onDuplicatePlan, onEditPlan, onNewPlan, onViewHistoryItem, onUpdateHistoryStatus, onExportData, onImportData, onImportFromPdf, isImportingPdf, pdfLibrariesLoaded }) => {
